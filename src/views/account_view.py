...
class AccountView:
    ...
    def create_widgets(self):
        ...
        label = ttk.Label(self.frame, text='Quản lý tài khoản', font=("Arial", 18))
        label.grid(row=row_idx, column=0, columnspan=2, padx=20, pady=5, sticky=tk.N)
        row_idx += 1

        # Frame danh sách tài khoản
        frame_list = ttk.LabelFrame(self.frame, text='Danh sách tài khoản')
        frame_list.grid(row=row_idx, column=0, columnspan=2, padx=10, pady=5, sticky=tk.NSEW)
        row_idx += 1
        ...
        ttk.Button(btn_frame, text='Tạo tài khoản mới', command=self.show_add_form).grid(row=0, column=0, padx=5, pady=5, sticky=tk.EW)
        ttk.Button(btn_frame, text='Sửa', command=self.show_edit_form).grid(row=0, column=1, padx=5, pady=5, sticky=tk.EW)
        ttk.Button(btn_frame, text='Xóa', command=self.delete_selected).grid(row=0, column=2, padx=5, pady=5, sticky=tk.EW)
